...
uint8 LCD_Page_Not_Selected [] = {0x00 , 0x00 , 0x0E , 0x11 , 0x15 , 0x11 , 0x0E , 0x00};
uint8 LCD_Page_Selected [] = {0x00 , 0x00 , 0x0E , 0x1F , 0x1F , 0x1F , 0x0E , 0x00};
uint8 LCD_Right_ICON [] = {0x00 , 0x01 , 0x03 , 0x16 , 0x1C , 0x08 , 0x00 , 0x00};
uint8 LCD_False_ICON [] = {0x00 , 0x11 , 0x0A , 0x04 , 0x0A , 0x11 , 0x00 , 0x00};
uint8 LCD_Mute_ICON [] = {0x00 , 0x08 , 0x1D , 0x1A , 0x1D , 0x08 , 0x00 , 0x00};
uint8 LCD_Skull_ICON [] = {0x0E , 0x15 , 0x1B , 0x0E , 0x0E , 0x00 , 0x00 , 0x00};
uint8 LCD_Alarm_ICON [] = {0x04 , 0x0E , 0x0E , 0x0E , 0x0E , 0x1F , 0x04 , 0x00};
